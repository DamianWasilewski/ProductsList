...
import { renderAll, renderThemeOnly } from 'utils/testUtils';
...
describe( 'SelectField', () => {
    ...
    it( 'should have first position from selectOptions array as value after render', async () => {
        const wrapper = renderAll( <SelectField id={ "test" } name={ "test" } selectOptions={ renderXOptions( 3 ) }/>, {} );
    ...
    it( 'should render selectedOption.length number of select options (length = 2)' , async () => {
        const wrapper = renderAll( <SelectField id={ "test" } name={ "test" } selectOptions={ renderXOptions( 2 ) }/>, {} );
    ...
    it( 'should render selectedOption.length number of select options (length = 15)' , async () => {
        const wrapper = renderAll( <SelectField id={ "test" } name={ "test" } selectOptions={ renderXOptions( 15 ) }/>, {} );
